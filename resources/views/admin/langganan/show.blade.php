                ...
                <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <form method="POST" action="{{ route('admin.langganan.bayar-cash', $paket) }}" class="mt-3 space-y-2">
                        ...
                        <input id="jumlah-cash" type="text" inputmode="numeric" name="jumlah"
                            value="{{ number_format($paket->sisaTagihan(), 0, '', '') }}" required
                        ...
                        <p class="text-[11px] text-slate-400">Maksimal Rp{{ number_format($paket->sisaTagihan(), 0, ',', '.') }} (sisa tagihan). Kalau diisi penuh, otomatis lunas.</p>
                    </form>
                </div>
                ...
                <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <div class="mt-3 space-y-2">
                        <input type="text" inputmode="numeric" id="jumlah-online"
                            value="{{ number_format($paket->sisaTagihan(), 0, '', '') }}"
                            class="input-rupiah w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-navy focus:outline-none focus:ring-1 focus:ring-navy/30">
